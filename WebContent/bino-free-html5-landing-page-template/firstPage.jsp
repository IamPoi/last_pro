      ...
      <div class="img"
         ...
         <div class="content">
            ...
            <div class="home_btn text-center">
                <a href="../InfluencerAllSelectService?name=adv" class="btn btn-lg m_t_10" style = "font-size: 20px">MARKETERS</a>
            </div>
         </div>
   ...
   <div class="col-sm-6" style="padding-left: 0px; padding-right: 0px;">
      <div class="img"
         ...
         <div class="content">
            ...
            <div class="home_btn text-center">
             <a href="../InfluencerAllSelectService?name=inf" class="btn btn-lg m_t_10" style = "font-size: 20px">INFLUENCERS</a>
            </div>
         </div>
